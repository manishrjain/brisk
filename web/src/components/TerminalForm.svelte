<script lang="ts">
  ...
  $: {
    ...
    fields = [
      ...
      { key: 'monthlyExpenses', label: 'Monthly Expenses', help: 'Utilities, HOA, etc. Use negative for income from the asset (e.g., -4k for rental income)', placeholder: '500', visible: () => true, fieldType: 'currency' },
